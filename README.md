...
If you want to type as little as possible, write code that clean, understandable, and radically minimal, and to let the computer to figure what you mean, read on. 
